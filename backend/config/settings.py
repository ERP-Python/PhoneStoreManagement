"""
Django settings for phone store management system.
"""
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': os.getenv('DB_PASSWORD', 'khanh20062003'),
...
# Store Configuration (can be moved to database later)
STORE_NAME = os.getenv('STORE_NAME', 'Cửa hàng điện thoại')
